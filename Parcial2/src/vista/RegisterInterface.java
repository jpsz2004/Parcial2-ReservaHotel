...
public class RegisterInterface extends JFrame{
    ...
    public void registrarUsuario() {
        ...
        if (registerController.verificarDatos(tipoIdentificacion, documentoIdentificacion, nombre, apellido, correo, direccionResidencia, ciudadResidencia, telefono, contrasena, confirmarContrasena)) {
            if (registerController.registerUser(tipoIdentificacion, documentoIdentificacion, nombre, apellido, correo, direccionResidencia, ciudadResidencia, telefono, contrasena, confirmarContrasena)) {
